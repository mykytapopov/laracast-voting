<x-app-layout>
    <div class="filters flex flex-col md:flex-row space-y-3 md:space-y-0 md:space-x-6">
        ...
        <div class="w-full md:w-2/3 relative">
            ...
            <input type="search" placeholder="Find and idea"
                   class="w-full rounded-xl bg-gray-800 px-4 py-2 pl-8 border-none placeholder-gray-500">
        </div>
    </div>
        ...
        @foreach($ideas as $idea)
            <div
                ...
                <div class="hidden md:block border-r border-gray-500 px-5 py-8">
                    ...
                    <div class="mt-8">
                        <button class="bg-gray-500 font-bold text-xs uppercase rounded-xl px-4 py-3 border border-gray-500 hover:border-gray-300 transition ease-in duration-150">
                            Vote
                        </button>
                    </div>
                </div>
                <div class="flex flex-col md:flex-row px-2 py-6 w-full">
                    ...
                    <div class="mx-4 w-full flex flex-col justify-between">
                        ...
                        <div class="flex md:items-center flex-col md:flex-row justify-between mt-6">
                            ...
                            >
                                <div
                                        class="status {{ strtolower($idea->status->name) }} text-xs font-bold uppercase leading-none rounded-full text-center w-28 h-7 px-4 py-2"
